...
$res = mysqli_query($dbb, "SELECT * FROM materiels WHERE Archive = 1 AND id = " .$_GET['id']);
...
<form id="modifier" class="last" method="post" action="modif.php?id=<?php echo $donnees["id"]; ?> ">
...
<td><a href="modif.php?id=<?php echo $donnees["id"]; ?> " >
