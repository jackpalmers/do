        ...
        <table>
            ...
            while($data = mysqli_fetch_array($res))
            {
                ...
                <tr id="delete[]" style="background:#99ccff;">
                    ...
                    <td><a href="../requetes/archiver.php?id=<?php echo $data["id"]; ?> " >Archiver</a></td>
                    <td><a href="../requetes/modifier.php?id=<?php echo $data["id"]; ?> " >Modifier</a></td>
            ...
            $res = mysqli_query($dbb, 'SELECT N°IMEI FROM materiels WHERE Archive = 1 AND N°IMEI = "" OR N°IMEI = "-" ');
            ...
            $res = mysqli_query($dbb, 'SELECT N°Entree_CRESA FROM materiels WHERE Archive = 1 AND N°Entree_CRESA = "" OR N°Entree_CRESA = "-" ');
