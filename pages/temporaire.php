...
while($data = mysqli_fetch_array($res))
  ...
  <td><a class="btn btn-warning" href="../requetes/modifiertemporaire.php?id=<?php echo $data["id"]; ?> " role="button" >Modifier</a></td>
...
$res = mysqli_query($dbb, 'SELECT Num_IMEI FROM materiels WHERE Archive = 2 AND Num_IMEI = "" OR Num_IMEI = "-" ');
...
if($donnees <= 0)
{
  echo "Il ne manque aucun Num_IMEI";
}
else
{
  echo "Il manque ".$donnees." Num_IMEI";
}

echo "</li>";

//------------------------------------------- CHAMPS Num_Entree_CRESA MANQUANT (vide)------------------------------------------------------

echo "<li>";

$res = mysqli_query($dbb, 'SELECT Num_Entree_CRESA FROM materiels WHERE Archive = 2 AND Num_Entree_CRESA = "" OR Num_Entree_CRESA = "-" ');
...
if($donnees <= 0)
{
  echo "Il ne manque aucun Num_Entree_CRESA";
}
else
{
  echo "Il manque ".$donnees." Num_Entree_CRESA";
}
